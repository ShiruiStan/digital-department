...
public class ProjectController {
    ...
    @PostMapping("/files")
    public StandardResponse addProjectFiles(@RequestBody MultipartFile file, @NonNull int id, String path) throws IOException {
        return StandardResponse.success(projectService.addProjectFiles(id , file , path));
    }
